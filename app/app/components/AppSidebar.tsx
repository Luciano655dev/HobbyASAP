        ...
        <div className="flex h-full flex-col">
          <div className="border-b border-border px-5 py-4">
            ...
            >
              <div
                aria-hidden="true"
                className="flex h-10 w-10 items-center justify-center rounded-2xl border border-border bg-linear-to-br from-accent to-accent-strong text-sm font-bold text-white shadow-sm"
              >
                H
              </div>
              <div>
          ...
          <div className="border-t border-border px-3 py-3">
            <div className="space-y-1">
              <Link
                href="/license"
                className="flex items-center gap-3 rounded-xl px-3 py-2 text-sm text-muted transition hover:bg-surface-2 hover:text-text"
              >
